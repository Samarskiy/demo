...
public class AuthService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["testApplication.shared.User/3250244733"] = [
        @testApplication.shared.User_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @testApplication.shared.User_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;LtestApplication/shared/User;),
      ];
    
    result["[LtestApplication.shared.User;/808365259"] = [
        @testApplication.shared.User_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @testApplication.shared.User_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[LtestApplication/shared/User;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@testApplication.shared.User::class)] = "testApplication.shared.User/3250244733";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@testApplication.shared.User[]::class)] = "[LtestApplication.shared.User;/808365259";
    return result;
  }-*/;
  
  public AuthService_TypeSerializer() {
